...
`32921520976`/`32921627748`/`32921627746` — **PASS**. Signed manifest имеет 1 273 bytes,
SHA-256 `860D90C22D9F404A38E783BD313A9E9A0FDEFC5BC870F933A819D35145489977`, issued
`2026-08-26T02:04:54Z`, expires `2026-09-25T02:04:54Z`. Pages manifest+APK, jsDelivr
manifest после targeted purge и ghfast/ghproxy/direct GitHub APK дали exact bytes.
Все live transports зависят от GitHub assets; независимый host не заявлен. Hardware и
in-app updater runtime остаются **PENDING**, release tag не является playback baseline.
