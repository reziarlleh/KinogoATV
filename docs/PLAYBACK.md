...
| Любое | Media Previous/Next | Предыдущая/следующая серия при наличии |
...
Настройка `autoNextEpisode` применяется к Media3 session. Сейчас отдельного визуального
обратного отсчёта следующей серии нет; целевое countdown-поведение из старой UX-спецификации
остаётся в roadmap.
